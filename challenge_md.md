...
[Shreyas]: Firstly I would check if the code formatting and naming conventions are fine.
Then would check for variable, function, class naming conventions. Also I would check for 
lenght of function and possible reuse of code/refactoring.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

[Shreyas]: Containers ensure there is no conflicts happening when multiple instances
of process or modules are deployed at the same time. Also using containers we can 
control the necessary deployment environment which can be minimal as per needs.
This will ensure there are no conflicts and even if one process goes down it would
